// Shared domain: time-slot definitions and helpers used by both frontend and backend.
// Keep this file pure (no framework imports) so it can be consumed from Node/Express and Vite.
