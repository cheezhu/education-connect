// Shared domain (CJS): group type/status/source metadata for frontend + backend parity.

const GROUP_TYPE_VALUES = Object.freeze(['primary', 'secondary', 'vip']);
...
const GROUP_TYPE_DISPLAY_ALIASES = Object.freeze({
  primary: Object.freeze(['小学', '小學']),
  secondary: Object.freeze(['中学', '中學']),
  vip: Object.freeze(['VIP', 'vip'])
});

const GROUP_CANCELLED_STATUS = '已取消';

const GROUP_STATUS_VALUES = Object.freeze([
  '准备中',
  '进行中',
  '已完成',
