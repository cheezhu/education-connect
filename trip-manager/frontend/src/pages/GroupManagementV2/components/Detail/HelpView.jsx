    ...
    <div className="group-help-grid">
      <section className="group-help-card">
        ...
        <ol>
          ...
          <li>进入“餐饮”“接送站”维护每日卡片中的三餐与接送站信息。</li>
          <li>进入“日历规划”确认时段安排并微调时间/时长。</li>
        </ol>
      </section>
      ...
      <section className="group-help-card">
        ...
        <ul>
          ...
          <li><strong>日历规划</strong>：可视化时段排程，支持拖拽调整。</li>
          <li><strong>行程点</strong>：查看“必去行程点 / 其他行程”两类卡片。</li>
          <li><strong>餐饮</strong>：按天维护每日三餐安排。</li>
          <li><strong>接送站</strong>：维护首日接站与末日送站信息。</li>
          <li><strong>行程导出</strong>：查看并导出文本化行程。</li>
          <li><strong>团员名单</strong>：维护团员名单与联系方式。</li>
          <li><strong>住宿安排</strong>：维护不同地点的酒店与房间安排。</li>
        </ul>
      </section>
      ...
      <section className="group-help-card">
        <h4>关键规则（请注意）</h4>
        <ul>
          <li>活动数据来源分为：行程点、餐饮、接送站、自定义。</li>
          <li>餐饮/接送站与日历映射活动保持联动，删除任一侧会同步。</li>
